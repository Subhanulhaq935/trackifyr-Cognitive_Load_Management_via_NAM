      ...
      >
        <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-900">
          ...
          <div className="px-8 py-8">
            <div className="mb-6">
              <h2 className="mb-1 text-2xl font-semibold text-gray-900 dark:text-slate-100">Create Your Account</h2>
              <p className="text-sm text-gray-600 dark:text-slate-400">Join our research platform to begin monitoring</p>
            </div>

            <form className="space-y-5" onSubmit={handleSubmit}>
              <div>
                <label htmlFor="fullName" className="mb-2 block text-sm font-medium text-gray-700 dark:text-slate-300">
                  Full Name
                </label>
                  ...
                  <input
                    ...
                    className={`block w-full rounded-lg border py-3 pl-12 pr-4 transition-all duration-200 focus:outline-none focus:ring-2 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-100 dark:focus:bg-slate-800 dark:hover:border-slate-500 ${
                      errors.fullName
                        ...
                        : 'border-gray-300 bg-gray-50 hover:border-gray-400 focus:border-blue-500 focus:bg-white focus:ring-blue-500'
                    }`}
              ...
              <div className="space-y-3 pt-4 text-center">
                <p className="text-sm text-gray-600 dark:text-slate-400">
                  ...
                  <Link
                    href="/signin"
                    className="inline-flex items-center font-semibold text-blue-600 transition-colors duration-200 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300"
                  >
                    Sign In
